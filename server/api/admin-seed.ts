...
export function getDefaultRuleSeeds() {
  return [
    ...
    createRule("employment-maintenance", "determination", "employment-maintenance.crisis", "equals", "no", {
      ...
      effectSummary: "경영상 사유가 없어 현재는 고용유지지원금 대상 가능성이 낮습니다.",
      effectMissingItem: "매출 감소 등 고용조정 불가피 사유",
      effectRationale: "경영상 사유 증빙이 없으면 고용유지지원금이 어렵습니다.",
      effectNextAction: "매출 감소나 휴업 사유를 객관적으로 정리하세요.",
      priority: 10,
    }),
    createRule("employment-maintenance", "determination", "employment-maintenance.crisis", "equals", "unknown", {
      effectStatus: "needs_followup",
      effectSummary: "고용유지지원금은 가능성이 있지만 경영상 사유 증빙이 먼저 필요합니다.",
      effectMissingItem: "경영상 사유 증빙",
      effectRationale: "휴업·휴직 계획 전에 경영상 사유를 정리해야 합니다.",
      effectNextAction: "매출 감소와 고용유지 계획 증빙을 준비하세요.",
      priority: 20,
    }),
    createRule("work-life-balance", "determination", "work-life-balance.shortenHours", "equals", "no", {
      effectStatus: "ineligible",
      effectSummary: "근로시간 단축 운영 계획이 없어 현재는 워라밸 일자리 장려금이 어렵습니다.",
      effectMissingItem: "근로시간 단축 제도 운영",
      effectRationale: "실제 단축 운영이 있어야 신청 가능합니다.",
      effectNextAction: "단축 제도와 임금 보전 구조를 먼저 설계하세요.",
      priority: 10,
    }),
    createRule("work-life-balance", "determination", "work-life-balance.tracking", "not_equals", "yes", {
      effectStatus: "needs_followup",
      effectSummary: "워라밸 일자리 장려금은 가능성이 있지만 근태·임금 보전 증빙이 더 필요합니다.",
      effectMissingItem: "근태기록 및 임금 감소 보전 증빙",
      effectRationale: "간접노무비와 보전금 신청에는 운영 증빙이 중요합니다.",
      effectNextAction: "근태관리 방식과 임금보전 기준을 문서화하세요.",
      priority: 20,
    }),
    createRule("work-life-45", "determination", "work-life-45.laborAgreement", "equals", "no", {
      effectStatus: "ineligible",
      effectSummary: "노사 합의가 없어 워라밸 4.5 프로젝트 대상 가능성이 낮습니다.",
      effectMissingItem: "노사 합의",
      effectRationale: "주 4.5일제 운영안과 합의 절차가 필요합니다.",
      effectNextAction: "노사 합의와 운영안을 먼저 확정하세요.",
      priority: 10,
    }),
    createRule("work-life-45", "determination", "work-life-45.foundationApproval", "not_equals", "yes", {
      effectStatus: "needs_followup",
      effectSummary: "공고 참여 준비가 남아 있어 워라밸 4.5 프로젝트는 보완 후 진행이 적합합니다.",
      effectMissingItem: "공고 참여 또는 운영 승인 준비",
      effectRationale: "공고형 사업은 신청 전에 참여 준비 상태가 중요합니다.",
      effectNextAction: "공고 일정과 내부 승인 절차를 점검하세요.",
      priority: 20,
    }),
    createRule("flexible-work", "determination", "flexible-work.policy", "equals", "no", {
      effectStatus: "ineligible",
      effectSummary: "유연근무 정책이 없어 현재는 일·가정 양립 환경개선 대상 가능성이 낮습니다.",
      effectMissingItem: "유연근무 운영 정책",
      effectRationale: "재택·선택근무 운영 정책이 있어야 지원이 가능합니다.",
      effectNextAction: "정책과 운영기준을 먼저 정리하세요.",
      priority: 10,
    }),
    createRule("flexible-work", "determination", "flexible-work.tracking", "not_equals", "yes", {
      effectStatus: "needs_followup",
      effectSummary: "유연근무 운영은 가능하지만 시스템 로그와 근태 증빙 보완이 필요합니다.",
      effectMissingItem: "시스템 로그 및 근태 증빙",
      effectRationale: "지원금 신청 시 실제 운영 증빙이 중요합니다.",
      effectNextAction: "시스템 도입 또는 로그 수집 방식을 확정하세요.",
      priority: 20,
    }),
    createRule("parental-leave-full", "determination", "parental-leave-full.leaveGranted", "equals", "no", {
      effectStatus: "ineligible",
      effectSummary: "육아휴직 부여 계획이 없어 현재는 대상 가능성이 낮습니다.",
      effectMissingItem: "30일 이상 육아휴직 부여",
      effectRationale: "실제 육아휴직 부여가 전제입니다.",
      effectNextAction: "육아휴직 운영 계획을 먼저 확정하세요.",
      priority: 10,
    }),
    createRule("parental-leave-full", "determination", "parental-leave-full.leaveGranted", "equals", "planned", {
      effectStatus: "needs_followup",
      effectSummary: "육아휴직 지원금은 가능성이 있지만 실제 부여 일정 확정이 필요합니다.",
      effectMissingItem: "육아휴직 부여 일정 확정",
      effectRationale: "부여 계획만 있는 단계입니다.",
      effectNextAction: "근로자별 휴직 일정과 신청 절차를 정리하세요.",
      priority: 20,
    }),
    createRule("parental-leave-replacement", "determination", "parental-leave-replacement.replacementHire", "equals", "no", {
      effectStatus: "ineligible",
      effectSummary: "대체인력 채용 계획이 없어 현재는 대체인력 지원금 대상이 어렵습니다.",
      effectMissingItem: "30일 이상 대체인력 채용",
      effectRationale: "대체인력 실제 채용이 필요합니다.",
      effectNextAction: "대체인력 채용 계획과 기간을 먼저 설계하세요.",
      priority: 10,
    }),
    createRule("parental-leave-replacement", "determination", "parental-leave-replacement.replacementHire", "equals", "planned", {
      effectStatus: "needs_followup",
      effectSummary: "대체인력 지원금은 가능성이 있지만 채용 일정 확정이 필요합니다.",
      effectMissingItem: "대체인력 채용 일정",
      effectRationale: "채용 예정 단계입니다.",
      effectNextAction: "대체인력 채용 공고와 근로계약 계획을 준비하세요.",
      priority: 20,
    }),
    createRule("work-sharing", "determination", "work-sharing.allowance", "equals", "no", {
      effectStatus: "ineligible",
      effectSummary: "업무분담 구조와 수당 계획이 없어 현재는 업무분담 지원금 대상이 어렵습니다.",
      effectMissingItem: "업무분담 지정 및 수당 구조",
      effectRationale: "업무분담자 지정과 수당 지급이 필요합니다.",
      effectNextAction: "업무분담 체계와 수당 기준을 먼저 정리하세요.",
      priority: 10,
    }),
    createRule("work-sharing", "determination", "work-sharing.allowance", "equals", "planned", {
      effectStatus: "needs_followup",
      effectSummary: "업무분담 지원금은 가능성이 있지만 수당 설계와 대상자 확정이 필요합니다.",
      effectMissingItem: "업무분담 수당 설계",
      effectRationale: "운영 기준이 확정되지 않았습니다.",
      effectNextAction: "업무분담 대상자와 수당 지급기준을 정리하세요.",
      priority: 20,
    }),
    createRule("parental-leave-childcare", "determination", "parental-leave-childcare.shortHours", "equals", "no", {
      effectStatus: "ineligible",
      effectSummary: "육아기 근로시간 단축 운영이 없어 현재는 지원 가능성이 낮습니다.",
      effectMissingItem: "30일 이상 육아기 근로시간 단축 운영",
      effectRationale: "근로시간 단축 실제 운영이 전제입니다.",
      effectNextAction: "단축 대상자와 운영 기간을 먼저 설계하세요.",
      priority: 10,
    }),
    createRule("parental-leave-childcare", "determination", "parental-leave-childcare.shortHours", "equals", "planned", {
      effectStatus: "needs_followup",
      effectSummary: "육아기 근로시간 단축 지원금은 가능성이 있지만 운영 일정 확정이 필요합니다.",
      effectMissingItem: "단축 운영 일정 확정",
      effectRationale: "운영 예정 단계입니다.",
      effectNextAction: "단축 시작일과 임금 처리 기준을 정리하세요.",
      priority: 20,
    }),
  ];
}
